...
class ProductClassifier:
    ...
    def prepare_training_data(self):
        # Voorbeeld training data (uitgebreid met meer variaties)
        training_data = [
            ...
            ("Waar is mijn cell phone?", "mobile-phone"),  # Engels woord
            ("I can't find my wallet", "wallet"),  # Engels gemengd
            ("My pen is gone", "pen"),  # Engels gemengd
            ("Do you have my keys?", "car-key"),  # Engels gemengd
            ("It's my wrist watch", "watch"),  # Engels gemengd
            ("I need my glasses", "glasses"),  # Engels gemengd
            ("I have lost my comb", "comb")  # Engels gemengd
        ]
